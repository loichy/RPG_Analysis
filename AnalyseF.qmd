...
Les données du Recensement parcellaires Graphiques (RPG) sont téléchargeables sur [ce site](https://geoservices.ign.fr/rpg) RPG stands for Registre Parcellaire Graphique which is a geographical information system permitting the identification of agricultural parcels, giving detailed information about crops and occupation of each parcel. The source of this data is declaration from the farmers.
